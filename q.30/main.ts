/*30. Hello Admin:Make an array of five or more usernames, including the name 'admin'. Imagine you are writing 
...
let username: string[] = ["umer","usman","admin","abubakar","mustufa"];
